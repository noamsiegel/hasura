// To parse this data:
//
//   import { Convert, AirportIataCodeResponse } from "./file";
//
//   const airportIataCode = Convert.toAirportIataCodeResponse(json);

import { Pagination,SearchPoint,Address,Geolocation,Rating,CurrencyExchangeRate,AvailabilityNote,Amenity,DistanceFromSearchPoint,Fax,ImageURL,Phone,Dimensions } from '../base_response';

export interface AirportIataCodeResponse {
...
//     public static toAirportIataCodeResponse(json: string): AirportIataCodeResponse {
//         return JSON.parse(json);
//     }

//     public static airportIataCodeToJson(value: AirportIataCodeResponse): string {
